...
public static ArrayList<cListViewColumns> ejerciciosEnfriantes = new ArrayList<cListViewColumns>() {{add(new cListViewColumns("Chandra Bedhana", "imagen1", "Nos sentamos de piernas cruzadas en una posición cómoda o sobre una silla, con la columna erguida.\n" +
    ...
    add(new cListViewColumns("Sitali", "imagen5", "Nos sentamos en una posición cómoda en un espacio tranquilo.\n" +
    ...
    add(new cListViewColumns("Shektari", "imagen10", "Nos sentamos en una posición cómoda en un espacio tranquilo con el rostro relajado.\n" +
            "Realizamos 3 inhalaciones y exhalaciones por la nariz. \n" +
    ...
    add(new cListViewColumns("Ommursa", "imagen6", "Nos sentamos en una posición cómoda en un espacio tranquilo con el rostro relajado.\n" +
        ...
        public static ArrayList<cListViewColumns> ejerciciosEquilibrantes = new ArrayList<cListViewColumns>() {{add(new cListViewColumns("Respiración cuadrada", "imagen3", "Nos sentamos de piernas cruzadas en una posición cómoda o sobre una silla, con la columna erguida. O también nos podemos recostar en una superficie cómoda.\n" +
            ...
            add(new cListViewColumns("Respiración circular", "imagen4", "Nos sentamos de piernas cruzadas en una posición cómoda o sobre una silla, con la columna erguida. O también nos podemos recostar en una superficie cómoda.\n" +
                    ...
                    "Esta respiración se puede repetir de 3 a 5 veces aproximadamente.", "Este ejercicio no tiene contraindicaciones."));
            add(new cListViewColumns("Respiración completa", "imagen10", "Nos sentamos de piernas cruzadas en una posición cómoda o sobre una silla, con la columna erguida. O también nos podemos recostar en una superficie cómoda.\n" +
                    ...
                    "Esta respiración se puede repetir de 3 a 5 veces aproximadamente.", "Este ejercicio no tiene contraindicaciones."));
            add(new cListViewColumns("Respiración Yoguica", "imagen9", "Nos sentamos de piernas cruzadas en una posición cómoda o sobre una silla, con la columna erguida. O también nos podemos recostar en una superficie cómoda.\n" +
                    ...
                    "Esta respiración se puede repetir de 3 a 5 veces aproximadamente.", "Este ejercicio no tiene contraindicaciones."));
            add(new cListViewColumns("Brahmari", "imagen8", "Nos sentamos de piernas cruzadas en una posición cómoda o sobre una silla, con la columna erguida. \n" +
                    ...
                    "Esta respiración se puede repetir de 3 a 5 veces aproximadamente.", "Este ejercicio no tiene contraindicaciones."));
            add(new cListViewColumns("Respiración alterna (Nadi Sodhana)", "imagen1", "Nos sentamos de piernas cruzadas en una posición cómoda o sobre una silla, con la columna erguida.\n" +
                    "Mano izquierda: la colocamos sobre la rodilla con la palma hacia arriba. Dedo índice y pulgar tocándose entre sí.\n" +
                    "Mano derecha: colocamos el dedo índice y mayor en la palma de la mano o sobre la frente en el entrecejo. Dedo pulgar en el orificio nasal derecho y dedo anular sobre el orificio nasal izquierdo.\n" +
                    ...
                    "La secuencia se puede repetir de 5 a 10 veces y, con el tiempo, se puede incrementar la cantidad de repeticiones.", "Este ejercicio no tiene contraindicaciones."));}};
        public static ArrayList<cListViewColumns> ejerciciosCalentantes = new ArrayList<cListViewColumns>() {{add(new cListViewColumns("Suria bedhana", "imagen1", "Nos sentamos de piernas cruzadas en una posición cómoda o sobre una silla, con la columna erguida.\n" +
                "Mano izquierda: la colocamos sobre la rodilla con la palma hacia arriba. Dedo índice y pulgar tocándose entre sí.\n" +
                "Mano derecha: colocamos el dedo índice y mayor en la palma de la mano o sobre la frente en el entrecejo. Dedo pulgar en el orificio nasal derecho y dedo anular sobre el orificio nasal izquierdo.\n" +
                ...
                "La secuencia se puede repetir de 5 a 10 veces y, con el tiempo, se puede incrementar la cantidad de repeticiones.", "Este ejercicio no tiene contraindicaciones."));
            add(new cListViewColumns("Ujjayi", "imagen10", "Esta respiración se puede realizar en cualquier posición que se desee.\n" +
            ...
            add(new cListViewColumns("Kapalabhati", "imagen7", "Nos sentamos de piernas cruzadas en una posición cómoda o sobre una silla, con la columna erguida.\n" +
            ...
            add(new cListViewColumns("Bastrica", "imagen7", "Nos sentamos de piernas cruzadas en una posición cómoda o sobre una silla, con la columna erguida.\n" +
